...
- End-to-end (runpod, `configs/ablate_2k_hybrid_flex.yaml`, compile+flex, `.venv` torch 2.11): no unfused warning, batch back to **mb=72**, loss **bit-exact to eager** (step20 3.7320, val 3.5924, step40 3.4810), **tok/s 30.5k vs eager 28.1k (~+8% at 2K)**.
